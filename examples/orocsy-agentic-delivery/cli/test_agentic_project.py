...
class AgenticProjectCliTests(unittest.TestCase):
    ...
    def test_init_writes_orocsy_runtime_workflow_and_start_guard(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("no-durable-progress", workflow)
            ...
            self.assertIn("missing durable progress watchdog guard", start_script)
...
""",
            ...
            self.assertIn("no-durable-progress", upgraded_workflow)
            ...
            self.assertIn("missing durable progress watchdog guard", upgraded_start)
