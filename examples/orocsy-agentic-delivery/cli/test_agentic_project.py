...
class AgenticProjectCliTests(unittest.TestCase):
    ...
    def test_init_writes_orocsy_runtime_workflow_and_start_guard(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("durable_progress_timeout_ms: 180000", workflow)
            self.assertIn("durable_progress_min_tokens: 250000", workflow)
            ...
            self.assertIn("missing token-budget immediate parking guard", start_script)
...
""",
            ...
            self.assertIn("durable_progress_timeout_ms: 180000", upgraded_workflow)
            self.assertIn("durable_progress_min_tokens: 250000", upgraded_workflow)
            ...
            self.assertIn("missing token-budget immediate parking guard", upgraded_start)
