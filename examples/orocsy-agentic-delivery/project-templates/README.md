...
| `code-assets/` | Runnable scaffold assets grouped by framework base, reusable patterns, third-party evaluations, and project overlays. |

## Rule

Never treat a profile as a command to use any previous stack. Profiles are
