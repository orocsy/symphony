defmodule SymphonyElixir.CoreTest do
  ...
  test "normal worker exit schedules active-state continuation retry" do
    ...
    assert_due_after_processing_window(due_at_ms, before_down_ms, after_state_ms, 1_000)
  end
  ...
  test "abnormal worker exit increments retry attempt progressively" do
    ...
    assert_due_after_processing_window(due_at_ms, before_down_ms, after_state_ms, 40_000)
  end
  ...
  test "first abnormal worker exit waits before retrying" do
    ...
    assert_due_after_processing_window(due_at_ms, before_down_ms, after_state_ms, 10_000)
  end
  ...
  defp assert_due_after_processing_window(
         due_at_ms,
         before_down_ms,
         after_state_ms,
         expected_delay_ms
