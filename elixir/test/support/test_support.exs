defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          review_monitor_request_timeout_ms: 30_000,
          worker_ssh_hosts: [],
    ...
    tracker_issue_allowlist = Keyword.get(config, :tracker_issue_allowlist)
    ...
    review_monitor_request_timeout_ms = Keyword.get(config, :review_monitor_request_timeout_ms)
    worker_ssh_hosts = Keyword.get(config, :worker_ssh_hosts)
    worker_max_concurrent_agents_per_host = Keyword.get(config, :worker_max_concurrent_agents_per_host)
    max_concurrent_agents = Keyword.get(config, :max_concurrent_agents)
    max_turns = Keyword.get(config, :max_turns)
    max_failed_worker_retries = Keyword.get(config, :max_failed_worker_retries)
    ...
    sections =
      [
        ...
        "  issue_allowlist: #{yaml_value(tracker_issue_allowlist)}",
        ...
        "  request_timeout_ms: #{yaml_value(review_monitor_request_timeout_ms)}",
        worker_yaml(worker_ssh_hosts, worker_max_concurrent_agents_per_host),
        "agent:",
        "  max_concurrent_agents: #{yaml_value(max_concurrent_agents)}",
        "  max_turns: #{yaml_value(max_turns)}",
        "  max_failed_worker_retries: #{yaml_value(max_failed_worker_retries)}",
